...
public class KCatalogGuiMenuAction {
	...
	//	System.out.println(menuName);
		...
		if("menuToolsASearch".equals(menuName)){
			viewMenu = false;
			showAdvancedSearch();
		}		
	...
	private void showAdvancedSearch(){
		KCatalogGuiSearchTab searchTab = 
							new KCatalogGuiSearchTab((JFrame)mainFrame,true);
		searchTab.setVisible(true);
	}
	
	private void showNotesDlg(){
		KCatalogGuiNotesDlg dlg = new KCatalogGuiNotesDlg(mainFrame);
		dlg.setVisible(true);
	}
